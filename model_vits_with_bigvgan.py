...
class Generator(torch.nn.Module):
    def __init__(self, initial_channel, resblock_kernel_sizes, resblock_dilation_sizes, upsample_rates,
                 upsample_initial_channel, upsample_kernel_sizes, gin_channels=0, rank=0):
        ...
        for i, (u, k) in enumerate(zip(upsample_rates, upsample_kernel_sizes)):
            self.ups.append(weight_norm(
                ConvTranspose1d(upsample_initial_channel // (2 ** i), upsample_initial_channel // (2 ** (i + 1)),
                                k, u, padding=upsample_rates[i] // 2 + upsample_rates[i] % 2,
        ...
        initial_freq = [500, 4000, 8000, 16000]
...
class SynthesizerTrn(nn.Module):
  ...
  """
    ...
    def forward(self, x, x_lengths, y, y_lengths, sid=None):
        ...
        # prior encoder - phoneme encoder - phoneme information extraction
        ...
        # posterior encoder --> linear spectrogram --> z
    ...
    def voice_conversion(self, y, y_lengths, sid_src, sid_tgt, z_p=None, y_mask=None):
