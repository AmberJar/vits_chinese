...
def main():
    ...
    parser.add_argument('-c', '--config', type=str, default="./configs/ziwei.json",
                        help='JSON file for configuration')
    parser.add_argument('-i', '--input_path', type=str, default="/mnt/data/fangpengcheng/data/ziwei_record/train_file")
    parser.add_argument('-o', '--output_path', type=str, default="./dataset/ziwei_npz")
